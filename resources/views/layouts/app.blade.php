    ...
    <header class="main-header">
        ...
        <div class="header-container">
            ...
            <div class="authorization-block">
                ...
                <a href="RegisterForm" class="authorization-block__link">Регистрация</a><a href="login" class="authorization-block__link">Войти</a>
                @endif
                    @if(Auth::user())
                        <a  class="authorization-block__link">{{ Auth::user()->name }}</a>
                        <a href={{route("logout")}} class="authorization-block__link">Exit</a>
                    @endif
            </div>
            ...
            <div class="sidebar-item">
                ...
                <div class="sidebar-item__content">
                    ...
                    <ul class="sidebar-category">
                        <li class="sidebar-category__item"><a href="category/"{{$oneCategory->name}} class="sidebar-category__item__link">{{$oneCategory->name}}</a></li>
                    </ul>
                    @endforeach
                </div>
            </div>
